<div align="center">
  ...
  <a href="https://thetechology.github.io/Music-Player-Marian-Dumitru/"><strong>➥ Live Demo</strong></a>
...
```bash
sudo git clone https://github.com/TheTechology/Music-Player-Marian-Dumitru.git
```

Windows:

```bash
git clone https://github.com/TheTechology/Music-Player-Marian-Dumitru.git
```

### Contact

marian@dumitru.family 
